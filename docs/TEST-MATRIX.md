...
| Staged startup and command deadlines | `test_bootstrap_runtime.py`, `test_start.py`, `test_process_runtime.py`: real-query readiness, build/bootstrap/readiness failures, replica selection, stdin/error preservation and real subprocess timeout fixtures | All four image builds and bootstrap completed during the latest responsive Docker interval; complete runtime readiness and a new Linux run remain pending |
